...
const HeroSection = () => {
  return (
    <section>
      ...
      repeat={Infinity}
    /></h1>
        <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat, quidem!</p>
        <div>
        ...
        <div className="col-span-5 place-self-center mt-4 lg:mt-0">
            ...
            <Image src="/images/Atharva_Hero_Section.png" alt="hero image" className="absolute transform -translate-x1/2 -translate-y-1/2 top-1/2 left-1/2" width={300} height={300}  
            />
            </div>
        </div>
            </div>
